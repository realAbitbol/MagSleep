...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-1%20malicious%2F75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/c0639374cc4e45149053ec2e9d77d6a6a7de6aae82939d700562dc073a2a3d3e/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.3.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.3    # build dist/MagSleep.app
make install VERSION=1.3.3  # copy to /Applications
# or
make dmg VERSION=1.3.3    # dist/MagSleep-1.3.3.dmg
```
