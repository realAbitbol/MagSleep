...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.4.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.4    # build dist/MagSleep.app
make install VERSION=1.3.4  # copy to /Applications
# or
make dmg VERSION=1.3.4    # dist/MagSleep-1.3.4.dmg
```
