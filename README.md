...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-0%20malicious%2F75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/8b0b47107c2d709721a9fa18d29bbf723d1a99442fef9a0464f224f8b41e0057/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.1.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.1    # build dist/MagSleep.app
make install VERSION=1.3.1  # copy to /Applications
# or
make dmg VERSION=1.3.1    # dist/MagSleep-1.3.1.dmg
```
