...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-1%20malicious%2F75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/0b3b597c2b46bd958c03c510f793ea7700e3e511c7f6a7daad214148f184207a/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.0.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.0    # build dist/MagSleep.app
make install VERSION=1.3.0  # copy to /Applications
# or
make dmg VERSION=1.3.0    # dist/MagSleep-1.3.0.dmg
```
