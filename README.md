...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.1.1.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.1.1    # build dist/MagSleep.app
make install VERSION=1.1.1  # copy to /Applications
# or
make dmg VERSION=1.1.1    # dist/MagSleep-1.1.1.dmg
```
