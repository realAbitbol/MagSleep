...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-0%20malicious%2F75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/22a45ac4eb5535a905ca82f669e0632c084dc924a994ee34bd0b234dde3716f0/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.7.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.7    # build dist/MagSleep.app
make install VERSION=1.3.7  # copy to /Applications
# or
make dmg VERSION=1.3.7    # dist/MagSleep-1.3.7.dmg
```
