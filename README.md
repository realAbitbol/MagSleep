...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-0%20malicious%2F75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/1f9630426d46ecdfcdd6c9a2b4445bd778372fce2f197225551bce55a0193b96/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.3.5.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.3.5    # build dist/MagSleep.app
make install VERSION=1.3.5  # copy to /Applications
# or
make dmg VERSION=1.3.5    # dist/MagSleep-1.3.5.dmg
```
