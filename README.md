...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.2.2.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.2.2    # build dist/MagSleep.app
make install VERSION=1.2.2  # copy to /Applications
# or
make dmg VERSION=1.2.2    # dist/MagSleep-1.2.2.dmg
```
