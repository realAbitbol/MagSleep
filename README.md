...
<!-- VT_BADGE -->
[![VirusTotal](https://img.shields.io/badge/VirusTotal-0%20malicious/75-4c1?logo=virustotal)](https://www.virustotal.com/gui/file/2936db5072fe25f975b2257a268bf854a920aad48ced402e71b931cbb1b95b6c/detection)
<!-- /VT_BADGE -->
...
```bash
xattr -d com.apple.quarantine ~/Downloads/MagSleep-1.2.10.dmg
```
...
git clone <repo-url>
cd MagSleep
make app VERSION=1.2.10    # build dist/MagSleep.app
make install VERSION=1.2.10  # copy to /Applications
# or
make dmg VERSION=1.2.10    # dist/MagSleep-1.2.10.dmg
```
